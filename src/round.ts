    ...
    if (isNaN(num)) {
        ...
        if (userSelect === "tofixed") {
            if (parseFloat(num.toFixed(3)) === num) {
                ...
                (document.querySelector('#output') as HTMLElement).innerHTML = `<p class="text-success">${num} rounded to the 3<sup>rd</sup> decimal digit is ${num.toFixed(3)
                    } </p>`;
                (<HTMLInputElement>document.querySelector('#num')).value = "";
            }
            ...
            if (Math.round(num) === num) {
                ...
                (document.querySelector('#output') as HTMLElement).innerHTML = `<p class="text-success">${num} rounded to the nearest integer is ${Math.round(num)
                    }</p>`;
                (<HTMLInputElement>document.querySelector('#num')).value = "";
            }
            ...
            if (Math.ceil(num) === num) {
                ...
                (document.querySelector('#output') as HTMLElement).innerHTML = `<p class="text-success">${num} rounded a number up to the next largest integer is ${Math.ceil(num)
                    }</p>`;
                (<HTMLInputElement>document.querySelector('#num')).value = "";
            }
            ...
            if (Math.floor(num) === num) {
                ...
                (document.querySelector('#output') as HTMLElement).innerHTML = `<p class="text-success">the largest integer less than or equal to ${num} is ${Math.floor(num)
                    }</p>`;
                (<HTMLInputElement>document.querySelector('#num')).value = "";
            }
        }
