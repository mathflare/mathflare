...
(document.querySelector('#button')as HTMLButtonElement).addEventListener('click', (event) => {
    ...
    if (isNaN(y) || isNaN(z)) {
        ...
        (document.querySelector('#output')as HTMLElement).innerHTML = `<p class="text-success">x = ${
            z - y
        }</p>`;
        (< HTMLInputElement > document.querySelector('#y')).value = "";
        (< HTMLInputElement > document.querySelector('#z')).value = "";
...
(document.querySelector('#button2')as HTMLButtonElement).addEventListener('click', (event) => {
    ...
    if (isNaN(y) || isNaN(z)) {
        ...
        (document.querySelector('#output2')as HTMLElement).innerHTML = `<p class="text-success">x = ${
            z + y
        }</p>`;
        (< HTMLInputElement > document.querySelector('#y2')).value = "";
        (< HTMLInputElement > document.querySelector('#z2')).value = "";
...
(document.querySelector('#button3')as HTMLButtonElement).addEventListener('click', (event) => {
    ...
    if (isNaN(y) || isNaN(z)) {
        ...
        (document.querySelector('#output3')as HTMLElement).innerHTML = `<p class="text-success">x = ${
            z / y
        }</p>`;
        (< HTMLInputElement > document.querySelector('#y3')).value = "";
        (< HTMLInputElement > document.querySelector('#z3')).value = "";
